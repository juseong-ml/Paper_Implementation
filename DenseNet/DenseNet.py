...
trainset = torchvision.datasets.CIFAR10(
    root='/workspace/zfsvol/juseong_data', train=True, download=True, transform=transform_train)

validset = torchvision.datasets.CIFAR10(
    root='/workspace/zfsvol/juseong_data', train=True, download=True, transform=transform_validation)

testset = torchvision.datasets.CIFAR10(
    root='/workspace/zfsvol/juseong_data', train=False, download=True, transform=transform_test)
